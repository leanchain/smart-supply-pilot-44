...
const DemoSlides = () => {
  ...
  const testimonials = [
    {
      quote:
        "Finally, something that works with our Excel sheets instead of trying to replace them!",
      name: "Operations Manager, GreenTech Manufacturing",
    },
    {
      quote:
        "Saved us from constant stockouts during our seasonal peaks when we couldn't forecast demand properly.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            2-minute demo: See how fast LeanChain transforms your supply
            planning
          </p>
          <Button
            size="lg"
